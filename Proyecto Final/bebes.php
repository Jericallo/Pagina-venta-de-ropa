    ...
    <table>
      ...
      <tr>
        ...
        <th>
          ...
          <div class="card " style="width: 18rem;">
            <img src="imagenes/ariel.jpg" class="card-img-top cartas " alt="...">

            <div class="card-body">
              <h5 class="card-title">Vestido ariel bebe </h5>
              <p class="card-text"> Vestido de bebe con estampado y dianema, con tallas 1, 2 y 3 años </p>
        ...
        <th>
          ...
          <div class="card" style="width: 18rem;">
            <img src="imagenes/blancanieves.jpg" class="card-img-top cartas" alt="...">
            <div class="card-body">
              <h5 class="card-title ">Vestido blancanieves bebe</h5>
              <p class="card-text ">Vestido de bebe con estampado y dianema, con tallas 1, 2 y 3 años </p>
              <div class="btn">
                <button type="button" class="btn btn-primary dropdown-toggle" data-bs-toggle="dropdown"
                  aria-expanded="false">
        ...
        <th>
          ...
          <div class="card" style="width: 18rem;">
            <img src="imagenes/elsa.jpg" class="card-img-top cartas" alt="...">
            <div class="card-body">
              <h5 class="card-title">Vestido Elsa bebe</h5>
              <p class="card-text">Vestido de bebe con estampado y dianema, con tallas 1, 2 y 3 años </p>
              <div class="btn">
                <button type="button" class="btn btn-primary dropdown-toggle" data-bs-toggle="dropdown"
                  aria-expanded="false">
        ...
        <th>
          ...
          <div class="card" style="width: 18rem;">
            ...
            <img src="imagenes/masha.jpg" class="card-img-top cartas" alt="...">
            <div class="card-body">
              <h5 class="card-title">Vestido Masha bebe </h5>
              <p class="card-text">Vestido de bebe con estampado y dianema, con tallas 1, 2 y 3 años </p>
              <div class="btn">
                <button type="button" class="btn btn-primary dropdown-toggle" data-bs-toggle="dropdown"
                  aria-expanded="false">
      ...
      <tr>
        ...
        <th>
          ...
          <div class="card" style="width: 18rem;">
            <img src="imagenes/mini.jpg" class="card-img-top cartas" alt="...">
            <div class="card-body">
              <h5 class="card-title">Vestido mimin rojo bebe</h5>
              <p class="card-text">Vestido de bebe con estampado y dianema, con tallas 1, 2 y 3 años.</p>
              <div class="btn">
                <button type="button" class="btn btn-primary dropdown-toggle" data-bs-toggle="dropdown"
                  aria-expanded="false">
        ...
        <th>
          ...
          <div class="card" style="width: 18rem;">
            <img src="imagenes/mini2.jpg" class="card-img-top cartas" alt="...">
            <div class="card-body">
              <h5 class="card-title">Vestido mimin rosa bebe</h5>
              <p class="card-text">Vestido de bebe con estampado y dianema, con tallas 1, 2 y 3 años. </p>
              <div class="btn">
                <button type="button" class="btn btn-primary dropdown-toggle" data-bs-toggle="dropdown"
                  aria-expanded="false">
        ...
        <th>
          ...
          <div class="card" style="width: 18rem;">
            <img src="imagenes/unicornio.jpg" class="card-img-top cartas" alt="...">
            <div class="card-body">
              <h5 class="card-title">Vestido unicornio bebe</h5>
              <p class="card-text">Vestido de bebe con estampado y dianema, con tallas 1, 2 y 3 años.</p>
              <div class="btn">
                <button type="button" class="btn btn-primary dropdown-toggle" data-bs-toggle="dropdown"
                  aria-expanded="false">
        ...
        <th>
          ...
          <div class="card" style="width: 18rem;">
            <img src="imagenes/unicornio2.jpg" class="card-img-top cartas" alt="...">
            <div class="card-body">
              <h5 class="card-title">Vestido unicornio bebe</h5>
              <p class="card-text">Vestido de bebe con estampado y dianema, con tallas 1, 2 y 3 años.</p>
              <div class="btn">
      ...
      <tr>
        ...
        <th>
          ...
          <div class="card" style="width: 18rem;">
            <img src="imagenes/ana.jpg" class="card-img-top cartas" alt="...">
            <div class="card-body">
              <h5 class="card-title"> Vestido Anna bebe</h5>
              <p class="card-text">Vestido de bebe con estampado y dianema, con tallas 1, 2 y 3 años. </p>
              <div class="btn">
                <button type="button" class="btn btn-primary dropdown-toggle" data-bs-toggle="dropdown"
                  aria-expanded="false">
        ...
        <th>
          ...
          <div class="card" style="width: 18rem;">
            <img src="imagenes/aurora.jpg" class="card-img-top cartas" alt="...">
            <div class="card-body">
              <h5 class="card-title">Vestido Aurora bebe</h5>
              <p class="card-text">Vestido de bebe con estampado y dianema, con tallas 1, 2 y 3 años.</p>
              <div class="btn">
                <button type="button" class="btn btn-primary dropdown-toggle" data-bs-toggle="dropdown"
                  aria-expanded="false">
        ...
        <th>
          ...
          <div class="card" style="width: 18rem;">
            <img src="imagenes/moana.jpg" class="card-img-top cartas" alt="...">
            <div class="card-body">
              <h5 class="card-title">Vestido Moana</h5>
              <p class="card-text">Vestido de bebe con estampado y dianema, con tallas 1, 2 y 3 años.</p>
              <div class="btn">
                <button type="button" class="btn btn-primary dropdown-toggle" data-bs-toggle="dropdown"
                  aria-expanded="false">
        ...
        <th>
          ...
          <div class="card" style="width: 18rem;">
            <img src="imagenes/moana2.jpg" class="card-img-top cartas" alt="...">
            <div class="card-body">
              <h5 class="card-title">Vestido Moana</h5>
              <p class="card-text">Vestido de bebe con estampado y dianema, con tallas 1, 2 y 3 años.</p>
              <div class="btn">

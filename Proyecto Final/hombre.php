    ...
    <table>
      ...
      <tr>
        ...
        <th>
          ...
          <div class="card " style="width: 18rem;">
            <img src="imagenes/hanyasud.jpg" class="card-img-top cartas " alt="...">

            <div class="card-body">
              <h5 class="card-title">Camiseta Anya hombre</h5>
              <p class="card-text"> Camisa con diseño de Anya con tallas ch, M, G y EXG. </p>
        ...
        <th>
          ...
          <div class="card" style="width: 18rem;">
            <img src="imagenes/hcaballeros.jpg" class="card-img-top cartas" alt="...">
            <div class="card-body">
              <h5 class="card-title ">Camiseta de caballeros</h5>
              <p class="card-text ">Camisa con diseño de caballeros con tallas ch, M, G y EXG. </p>
              <div class="btn">
                <button type="button" class="btn btn-primary dropdown-toggle" data-bs-toggle="dropdown"
                  aria-expanded="false">
                  Elije y añade
        ...
        <th>
          ...
          <div class="card" style="width: 18rem;">
            <img src="imagenes/hcalaca.jpg" class="card-img-top cartas" alt="...">
            <div class="card-body">
              <h5 class="card-title">Camiseta esqueleto hombre</h5>
              <p class="card-text">Camisa con diseño de esqueleto brillante tallas ch, M, G y EXG.</p>
              <div class="btn">
                <button type="button" class="btn btn-primary dropdown-toggle" data-bs-toggle="dropdown"
                  aria-expanded="false">
                  Elije y añade
        ...
        <th>
          ...
          <div class="card" style="width: 18rem;">
            ...
            <img src="imagenes/hchukysud.jpg" class="card-img-top cartas" alt="...">
            <div class="card-body">
              <h5 class="card-title">Sudadera de chuky Hombre</h5>
              <p class="card-text">Sudadera con diseño de chuky con tallas ch, M, G y EXG.</p>
              <div class="btn">
                <button type="button" class="btn btn-primary dropdown-toggle" data-bs-toggle="dropdown"
                  aria-expanded="false">
                  Elije y añade
      ...
      <tr>
        ...
        <th>
          ...
          <div class="card" style="width: 18rem;">
            <img src="imagenes/hgoku.jpg" class="card-img-top cartas" alt="...">
            <div class="card-body">
              <h5 class="card-title">Camiseta de goku hombre</h5>
              <p class="card-text">Camisa con diseño de goku con tallas ch, M, G y EXG.</p>
              <div class="btn">
                <button type="button" class="btn btn-primary dropdown-toggle" data-bs-toggle="dropdown"
                  aria-expanded="false">
                  Elije y añade
        ...
        <th>
          ...
          <div class="card" style="width: 18rem;">
            <img src="imagenes/hgoku2.jpg" class="card-img-top cartas" alt="...">
            <div class="card-body">
              <h5 class="card-title">Camiseta de goku hombre</h5>
              <p class="card-text">Camisa con diseño de goku con tallas ch, M, G y EXG.</p>
              <div class="btn">
        ...
        <th>
          ...
          <div class="card" style="width: 18rem;">
            <img src="imagenes/hhomero.jpg" class="card-img-top cartas" alt="...">
            <div class="card-body">
              <h5 class="card-title">Camiseta homero hombre</h5>
              <p class="card-text">Camisa con diseño de homero con tallas ch, M, G y EXG.</p>
              <div class="btn">
                <button type="button" class="btn btn-primary dropdown-toggle" data-bs-toggle="dropdown"
                  aria-expanded="false">
                  Elije y añade
        ...
        <th>
          ...
          <div class="card" style="width: 18rem;">
            <img src="imagenes/hjack.jpg" class="card-img-top cartas" alt="...">
            <div class="card-body">
              <h5 class="card-title">Camiseta de jack hombre</h5>
              <p class="card-text">Camisa con diseño de jack con tallas ch, M, G y EXG.</p>
              <div class="btn">
                <button type="button" class="btn btn-primary dropdown-toggle" data-bs-toggle="dropdown"
                  aria-expanded="false">
                  Elije y añade
      ...
      <tr>
        ...
        <th>
          ...
          <div class="card" style="width: 18rem;">
            <img src="imagenes/hjacksud.jpg" class="card-img-top cartas" alt="...">
            <div class="card-body">
              <h5 class="card-title">Sudadera jack hombre</h5>
              <p class="card-text">Sudadera con diseño de Jack con tallas ch, M, G y EXG.</p>
              <div class="btn">
                <button type="button" class="btn btn-primary dropdown-toggle" data-bs-toggle="dropdown"
                  aria-expanded="false">
                  Elije y añade
        ...
        <th>
          ...
          <div class="card" style="width: 18rem;">
            <img src="imagenes/hone.jpg" class="card-img-top cartas" alt="...">
            <div class="card-body">
              <h5 class="card-title">Camiseta onepiece Hombre</h5>
              <p class="card-text">Camisa con diseño de onepiece con tallas ch, M, G y EXG.</p>
              <div class="btn">
                <button type="button" class="btn btn-primary dropdown-toggle" data-bs-toggle="dropdown"
                  aria-expanded="false">
                  Elije y añade
        ...
        <th>
          ...
          <div class="card" style="width: 18rem;">
            <img src="imagenes/htortugas.jpg" class="card-img-top cartas" alt="...">
            <div class="card-body">
              <h5 class="card-title">Camiseta totujas hombre</h5>
              <p class="card-text">Camisa con diseño de totujas con tallas ch, M, G y EXG.</p>
              <div class="btn">
                <button type="button" class="btn btn-primary dropdown-toggle" data-bs-toggle="dropdown"
                  aria-expanded="false">
                  Elije y añade
        ...
        <th>
          ...
          <div class="card" style="width: 18rem;">
            <img src="imagenes/htortugas2.jpg" class="card-img-top cartas" alt="...">
            <div class="card-body">
              <h5 class="card-title">Camiseta totujas hombre</h5>
              <p class="card-text">Camisa con diseño de totujas con tallas ch, M, G y EXG.</p>
              <div class="btn">
